...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Skopiuj ID z adresu panelu i cookie auth z narzędzi deweloperskich przeglądarki. OpenDeputy nigdy nie skanuje plików cookie przeglądarki.',
  ...
  'settings.github.page.flow.title': 'Autoryzuj OpenDeputy',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Dostępne jako rezerwa, jeśli uwierzytelnienie OpenDeputy zostanie usunięte',
  ...
  'settings.notifications.page.testNotification.body': 'To jest powiadomienie testowe z OpenDeputy.',
  ...
  'settings.openchamber.about.title': 'O OpenDeputy',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj OpenDeputy przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj OpenDeputy przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj OpenDeputy na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj OpenDeputy na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu OpenDeputy nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Zamykaj OpenDeputy do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje OpenDeputy w zasobniku systemowym, gdy główne okno zostanie zamknięte. Minimalizacja pozostawia okno na pasku zadań.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy OpenDeputy jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy OpenDeputy jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpenDeputy pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.openchamber.opencodeCli.field.autoUpdate': 'Aktualizuj OpenCode automatycznie',
  'settings.openchamber.opencodeCli.field.autoUpdateAria': 'Aktualizuj OpenCode automatycznie',
  'settings.openchamber.opencodeCli.field.autoUpdateDescription': 'Instaluj przyszłe aktualizacje OpenCode bez wyświetlania monitu o dostępności.',
  ...
  'settings.openchamber.tools.title': 'Narzędzia OpenDeputy',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Narzędzie OpenDeputy Web',
  'settings.openchamber.tools.field.agentWebToolAria': 'Włącz narzędzie OpenDeputy Web',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Pozwól agentom oglądać stronę w panelu przeglądarki OpenDeputy i wchodzić z nią w interakcję: otwierać adres URL, czytać treść, klikać, pisać, przewijać i przełączać między układem mobilnym a desktopowym. Dodaje krótki opis narzędzia do każdej sesji. Zastosowane po ponownym uruchomieniu OpenCode.',
  ...
  'settings.page.appearance.description': 'Dostosuj wygląd i odczucie OpenDeputy.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez OpenDeputy.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Przechowywany w auth OpenCode, nie przez OpenDeputy. Użyj {env:VAR_NAME}, aby odczytać klucz ze zmiennej środowiskowej.',
  ...
  'settings.remoteInstances.page.description': 'Połącz się z inną maszyną przez SSH i otwórz tam OpenDeputy.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'Jak OpenDeputy ma zostać umieszczony na zdalnej maszynie, gdy aplikacja uruchamia go za Ciebie.',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': 'Pozostaw OpenDeputy uruchomiony na zdalnej maszynie po rozłączeniu.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Wybierz, czy OpenDeputy ma uruchomić serwer za Ciebie, czy połączyć się z już działającym.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie OpenDeputy',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie OpenDeputy',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Opcjonalne dane logowania dla SSH i zdalnego interfejsu OpenDeputy.',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Wybierz lokalny adres używany do otwierania tego zdalnego serwera OpenDeputy.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'OpenDeputy na zdalnej maszynie',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Wybierz, jak OpenDeputy ma działać po połączeniu SSH.',
  ...
  'settings.remoteInstances.direct.title': 'Inne serwery OpenDeputy',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Dodaj inny serwer OpenDeputy przez URL. Użyj tego, gdy serwer już działa i masz token połączenia.',
  ...
  'settings.remoteInstances.direct.import.description': 'Wklej link połączenia z innego serwera OpenDeputy.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Nieprawidłowy link połączenia OpenDeputy.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Utwórz bezpieczny link lub token, aby OpenDeputy Desktop mógł połączyć się z tym serwerem.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Kod QR połączenia OpenDeputy',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Powiększ kod QR',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Zeskanuj to aplikacją OpenDeputy na drugim urządzeniu. Jednorazowy i wygasa.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Działa w domu i poza nim. Poza domem ruch przechodzi przez OpenDeputy Private Relay — szyfrowany end-to-end tunel. Bez konfiguracji.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Zeskanuj ten kod QR aplikacją OpenDeputy na drugim urządzeniu.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Dodaj repozytorium Git jako nowe źródło katalogu. OpenDeputy przeskanuje je w poszukiwaniu folderów zawierających',
  ...
  'settings.window.description': 'Okno ustawień OpenDeputy.',
