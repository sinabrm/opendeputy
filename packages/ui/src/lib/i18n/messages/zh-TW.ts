...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 OpenDeputy 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'OpenDeputy 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 OpenDeputy',
  ...
  'mobile.connect.password.placeholder': 'OpenDeputy 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 OpenDeputy 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 OpenDeputy Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 OpenDeputy 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 OpenDeputy。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 OpenDeputy，但與此應用程式版本不相容。請更新伺服器上的 OpenDeputy 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 OpenDeputy 伺服器與此應用程式版本不相容。請更新伺服器上的 OpenDeputy 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 OpenDeputy',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 OpenDeputy 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 執行在 OpenDeputy 所在的機器上，無法與其建立連線。這裡不會顯示你本機上的任何內容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 OpenDeputy 的那台機器上。要開啟它們需要桌面應用程式。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 OpenDeputy 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 OpenDeputy 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenDeputy 需要存取此資料夾。',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpenDeputy 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpenDeputy 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 OpenDeputy',
  ...
  'header.actions.openAppMenu': 'OpenDeputy 選單',
  'header.actions.openAppMenuAria': '開啟 OpenDeputy 選單',
  ...
  'chat.voiceMode.start': '開始語音對話',
  'chat.voiceMode.title': '語音對話',
  'chat.voiceMode.description': '與 OpenDeputy 自然交談。關閉此畫面後，對話仍會保留在聊天中。',
  'chat.voiceMode.preparing': '正在準備...',
  'chat.voiceMode.thinking': '正在思考...',
  'chat.voiceMode.speaking': '正在說話...',
  'chat.voiceMode.finishTurn': '結束說話',
  'chat.voiceMode.finishTurnHint': '自然說話即可；短暫停頓後會傳送訊息。',
  'chat.voiceMode.muted': '麥克風已暫停',
  'chat.voiceMode.mute': '暫停麥克風',
  'chat.voiceMode.unmute': '恢復麥克風',
  'chat.voiceMode.close': '關閉語音對話',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 OpenDeputy，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 OpenDeputy',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 OpenDeputy 伺服器之間切換',
  ...
  'multiRun.window.description': 'OpenDeputy 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 OpenDeputy',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenDeputy 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 OpenDeputy 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 OpenDeputy 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 OpenDeputy 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 OpenDeputy 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 OpenDeputy。請確認位址是否指向 OpenDeputy 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 OpenDeputy。請確認位址是否指向 OpenDeputy 伺服器。',
  ...
  'startup.initRecovery.description': 'OpenDeputy 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 OpenDeputy...',
  ...
  'mobileUpdate.toast.available.title': 'OpenDeputy 更新可用',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 OpenDeputy 開啟。',
  ...
  'openChamberLogo.aria.logo': 'OpenDeputy 標誌',
