...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Installez OpenDeputy pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'OpenDeputy installé',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'À propos de OpenDeputy',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur OpenDeputy auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans OpenDeputy. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenDeputy doit accéder à ce dossier.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Version OpenDeputy {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état OpenDeputy, l’état de santé OpenCode, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans OpenDeputy',
  ...
  'header.actions.openAppMenu': 'Menu de OpenDeputy',
  'header.actions.openAppMenuAria': 'Ouvrir le menu OpenDeputy',
  ...
  'chat.voiceMode.start': 'Démarrer une conversation vocale',
  'chat.voiceMode.title': 'Conversation vocale',
  'chat.voiceMode.description': 'Parlez naturellement avec OpenDeputy. Fermer cette vue conserve la conversation dans le chat.',
  'chat.voiceMode.preparing': 'Préparation...',
  'chat.voiceMode.thinking': 'Réflexion...',
  'chat.voiceMode.speaking': 'Réponse vocale...',
  'chat.voiceMode.finishTurn': 'Terminer de parler',
  'chat.voiceMode.finishTurnHint': 'Parlez naturellement ; une courte pause envoie votre message.',
  'chat.voiceMode.muted': 'Microphone en pause',
  'chat.voiceMode.mute': 'Mettre le microphone en pause',
  'chat.voiceMode.unmute': 'Réactiver le microphone',
  'chat.voiceMode.close': 'Fermer la conversation vocale',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez OpenDeputy depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez OpenDeputy',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs OpenDeputy locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution OpenDeputy.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur OpenDeputy',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si OpenDeputy ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de OpenDeputy — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres OpenDeputy et recharge la configuration OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur OpenDeputy auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur OpenDeputy ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas OpenDeputy. Vérifiez que l\'adresse pointe vers un serveur OpenDeputy.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas OpenDeputy. Vérifiez que l\'adresse pointe vers un serveur OpenDeputy.',
  ...
  'startup.initRecovery.description': 'OpenDeputy n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de OpenDeputy...',
  ...
  'mobileUpdate.toast.available.title': 'Mise à jour OpenDeputy disponible',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Gardez OpenDeputy ouvert.',
  ...
  'openChamberLogo.aria.logo': 'Logo OpenDeputy',
  ...
  'mobile.connect.welcome.title': 'Se connecter à OpenDeputy',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe OpenDeputy',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion OpenDeputy.',
  ...
  'mobile.connect.relay.badge': 'via OpenDeputy Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur OpenDeputy.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve OpenDeputy, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge OpenDeputy. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à OpenDeputy — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’OpenDeputy. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute OpenDeputy mais n’est pas compatible avec cette version de l’application. Mettez OpenDeputy à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur OpenDeputy à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez OpenDeputy à jour sur le serveur, puis réessayez.',
