...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copia el ID desde la URL del panel y la cookie auth desde las herramientas del navegador. OpenDeputy nunca examina las cookies del navegador.',
  ...
  "settings.window.description": "Ventana de configuración de OpenDeputy.",
  ...
  "settings.page.appearance.description": "Personaliza el aspecto y la sensación de OpenDeputy.",
  ...
  "settings.remoteInstances.direct.title": "Otros servidores de OpenDeputy",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Añade otro servidor de OpenDeputy por URL. Úsalo cuando el servidor ya esté en marcha y tengas un token de conexión.",
  ...
  "settings.remoteInstances.direct.import.description": "Pega un enlace de conexión de otro servidor de OpenDeputy.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Enlace de conexión de OpenDeputy no válido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crea un enlace o token seguro para que OpenDeputy Desktop pueda conectarse a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "OpenDeputy connection QR code",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Ampliar código QR",
  "settings.remoteInstances.clientAuth.qrScanHint": "Escanéalo con la app de OpenDeputy en tu otro dispositivo. Es de un solo uso y caduca.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona en casa y fuera. Fuera de casa el tráfico pasa por OpenDeputy Private Relay, un túnel cifrado de extremo a extremo. Sin configuración.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escanea este código QR con la app de OpenDeputy en tu otro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Elige si OpenDeputy debe iniciar el servidor por ti o conectarse a uno que ya está en marcha.",
  ...
  "settings.remoteInstances.page.field.keepServerRunningHint": "Keep OpenDeputy running on the remote machine after you disconnect.",
  ...
  "settings.openchamber.about.title": "Acerca de OpenDeputy",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Añade un repositorio Git como nuevo origen de catálogo. OpenDeputy escaneará para encontrar carpetas que contengan",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar OpenDeputy al iniciar sesión",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar OpenDeputy al iniciar sesión",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar OpenDeputy en la barra de menús de macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar OpenDeputy en la barra de menús",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Requiere reiniciar la aplicación. Al desactivarlo, OpenDeputy no crea el elemento de la barra de menús ni ejecuta sus actualizaciones de sesiones, aprobaciones y uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Cerrar OpenDeputy a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Cerrar a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantiene OpenDeputy en ejecución en la bandeja del sistema cuando se cierra la ventana principal. Al minimizar, la ventana sigue en la barra de tareas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Mantener el ordenador activo mientras OpenDeputy está en ejecución",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Mantener el ordenador activo mientras OpenDeputy está en ejecución",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "OpenDeputy la pide después del reinicio y luego cuando vence la sesión: tras 12 horas, o 7 días con Confiar en este dispositivo. Déjalo vacío para desactivar el inicio de sesión.",
  ...
  "settings.openchamber.tools.title": "Herramientas de OpenDeputy",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Herramienta OpenDeputy Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Activar la herramienta OpenDeputy Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permite que los agentes vean la página en el panel de navegador de OpenDeputy e interactúen con ella: abrir una URL, leer el contenido, hacer clic, escribir, desplazarse y alternar entre diseño móvil y de escritorio. Añade una pequeña descripción de herramienta a cada sesión. Se aplica tras reiniciar OpenCode.",
  ...
  "settings.openchamber.opencodeCli.field.autoUpdate": "Actualizar OpenCode automáticamente",
  "settings.openchamber.opencodeCli.field.autoUpdateAria": "Actualizar OpenCode automáticamente",
  "settings.openchamber.opencodeCli.field.autoUpdateDescription": "Instala futuras actualizaciones de OpenCode sin mostrar el aviso de disponibilidad.",
  ...
  "settings.remoteInstances.page.description": "Conéctate a otra máquina por SSH y abre OpenDeputy allí.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "OpenDeputy en la máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Elige cómo debe ejecutarse OpenDeputy después de conectar por SSH.",
  "settings.remoteInstances.page.section.mainTunnel": "Acceso local",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Elige la dirección local que se usará para abrir este servidor remoto de OpenDeputy.",
  "settings.remoteInstances.page.section.authentication": "Autenticación",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciales opcionales para SSH y la interfaz de usuario de OpenDeputy remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Cómo debe colocarse OpenDeputy en la máquina remota cuando esta app lo inicia por ti.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Instalando OpenDeputy",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Actualizando OpenDeputy",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Se guarda en la autenticación de OpenCode, no en OpenDeputy. Usa {env:VAR_NAME} para leer una clave del entorno.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Las claves se envían directamente a OpenCode y nunca se almacenan en OpenDeputy.",
  ...
  "settings.github.page.flow.title": "Autorizar OpenDeputy",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponible como respaldo si se elimina la autenticación de OpenDeputy",
  ...
  "settings.notifications.page.testNotification.body": "Esta es una notificación de prueba de OpenDeputy.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcripción local en el servidor de OpenDeputy. Los modelos se descargan automáticamente; no se necesita clave de API.",
  "settings.voice.page.tooltip.sttMuse": "Transcripción en la nube con Muse al terminar la grabación. No requiere descargar un modelo local ni una clave de API.",
  "settings.voice.page.tooltip.localTts": "Síntesis gratuita en el dispositivo (Kokoro para inglés, Piper para persa y voces del dispositivo para otros idiomas). Los modelos se descargan automáticamente; no hace falta clave API.",
