...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala OpenDeputy para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "OpenDeputy se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a OpenDeputy",
  ...
  "mobile.connect.password.placeholder": "Contraseña de OpenDeputy",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de OpenDeputy.",
  ...
  "mobile.connect.relay.badge": "a través de OpenDeputy Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de OpenDeputy.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de OpenDeputy",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de OpenDeputy al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está OpenDeputy y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja OpenDeputy. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a OpenDeputy: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en OpenDeputy. Descárgalo para abrirlo con otra aplicación.",
  ...
  'chat.voiceMode.start': 'Iniciar conversación por voz',
  'chat.voiceMode.title': 'Conversación por voz',
  'chat.voiceMode.description': 'Habla con naturalidad con OpenDeputy. Al cerrar esta vista, la conversación queda en el chat.',
  'chat.voiceMode.preparing': 'Preparando...',
  'chat.voiceMode.thinking': 'Pensando...',
  'chat.voiceMode.speaking': 'Hablando...',
  'chat.voiceMode.finishTurn': 'Terminar de hablar',
  'chat.voiceMode.finishTurnHint': 'Habla con naturalidad; una pausa breve enviará tu mensaje.',
  'chat.voiceMode.muted': 'Micrófono en pausa',
  'chat.voiceMode.mute': 'Pausar micrófono',
  'chat.voiceMode.unmute': 'Reanudar micrófono',
  'chat.voiceMode.close': 'Cerrar conversación por voz',
  ...
  "directoryExplorerDialog.browse.permissionDenied": "OpenDeputy necesita acceso a esta carpeta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de OpenDeputy {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de OpenDeputy, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por OpenDeputy de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de OpenDeputy",
  "header.actions.openAppMenuAria": "Abrir menú de OpenDeputy",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres OpenDeputy desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear OpenDeputy",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de OpenDeputy",
  ...
  "multiRun.window.description": "Ventana de OpenDeputy Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a OpenDeputy",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si OpenDeputy no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de OpenDeputy. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de OpenDeputy y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de OpenDeputy para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor OpenDeputy o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de OpenDeputy. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta OpenDeputy pero no es compatible con esta versión de la app. Actualiza OpenDeputy en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando OpenDeputy. Verifica que la dirección apunte a un servidor OpenDeputy.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando OpenDeputy. Verifica que la dirección apunte a un servidor OpenDeputy.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor OpenDeputy en \"{host}\" no es compatible con esta versión de la app. Actualiza OpenDeputy en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "OpenDeputy no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando OpenDeputy...",
  ...
  "mobileUpdate.toast.available.title": "Actualización de OpenDeputy disponible",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén OpenDeputy abierto.",
  ...
  "openChamberLogo.aria.logo": "Logo de OpenDeputy",
