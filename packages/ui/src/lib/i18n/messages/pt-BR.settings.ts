...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copie o ID da URL do painel e o cookie auth das ferramentas do navegador. O OpenDeputy nunca examina os cookies do navegador.',
  ...
  "settings.window.description": "Janela de configurações do OpenDeputy.",
  ...
  "settings.page.appearance.description": "Personalize a aparência e a sensação do OpenDeputy.",
  ...
  "settings.remoteInstances.direct.title": "Outros servidores OpenDeputy",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Adicione outro servidor OpenDeputy por URL. Use isto quando o servidor já estiver em execução e você tiver um token de conexão.",
  ...
  "settings.remoteInstances.direct.import.description": "Cole um link de conexão de outro servidor OpenDeputy.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Link de conexão do OpenDeputy inválido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crie um link ou token seguro para que o OpenDeputy Desktop possa se conectar a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrScanHint": "Escaneie com o app OpenDeputy no seu outro dispositivo. É de uso único e expira.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona em casa e fora. Fora de casa o tráfego passa pelo OpenDeputy Private Relay, um túnel criptografado de ponta a ponta. Sem configuração.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escaneie este código QR com o app OpenDeputy no seu outro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Escolha se o OpenDeputy deve iniciar o servidor para você ou se conectar a um que já está em execução.",
  ...
  "settings.openchamber.about.title": "Sobre o OpenDeputy",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Adicione um repositório Git como nova origem de catálogo. O OpenDeputy escaneará para encontrar pastas que contenham",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar o OpenDeputy ao fazer login",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar o OpenDeputy ao fazer login",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar o OpenDeputy na barra de menus do macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar o OpenDeputy na barra de menus",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Exige reiniciar o aplicativo. Quando desativado, o OpenDeputy não cria o item da barra de menus nem executa as atualizações de sessões, aprovações e uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Fechar o OpenDeputy na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Fechar na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantém o OpenDeputy em execução na bandeja do sistema quando a janela principal é fechada. Ao minimizar, a janela permanece na barra de tarefas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Manter o computador ativo enquanto o OpenDeputy estiver em execução",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Manter o computador ativo enquanto o OpenDeputy estiver em execução",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "O OpenDeputy pede após reiniciar e depois quando a sessão expira: em 12 horas, ou 7 dias com Confiar neste dispositivo. Deixe vazio para desativar o login.",
  ...
  "settings.openchamber.tools.title": "Ferramentas do OpenDeputy",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Ferramenta OpenDeputy Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Ativar a ferramenta OpenDeputy Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permita que agentes vejam a página no painel de navegador do OpenDeputy e interajam com ela: abrir uma URL, ler o conteúdo, clicar, digitar, rolar e alternar entre layout móvel e desktop. Adiciona uma pequena descrição de ferramenta a cada sessão. Aplicado após reiniciar o OpenCode.",
  ...
  "settings.openchamber.opencodeCli.field.autoUpdate": "Atualizar o OpenCode automaticamente",
  "settings.openchamber.opencodeCli.field.autoUpdateAria": "Atualizar o OpenCode automaticamente",
  "settings.openchamber.opencodeCli.field.autoUpdateDescription": "Instala futuras atualizações do OpenCode sem mostrar o aviso de disponibilidade.",
  ...
  "settings.remoteInstances.page.description": "Conecte-se a outra máquina por SSH e abra o OpenDeputy lá.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "OpenDeputy na máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Escolha como o OpenDeputy deve rodar depois que o SSH conectar.",
  "settings.remoteInstances.page.section.mainTunnel": "Acesso local",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Escolha o endereço local usado para abrir este servidor OpenDeputy remoto.",
  "settings.remoteInstances.page.section.authentication": "Autenticação",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciais opcionais para SSH e para a interface de usuário do OpenDeputy remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Como o OpenDeputy deve ser colocado na máquina remota quando este app o inicia para você.",
  ...
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Atualizando OpenDeputy",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Armazenada na autenticação do OpenCode, não pelo OpenDeputy. Use {env:VAR_NAME} para ler uma chave do ambiente.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "As chaves são enviadas diretamente ao OpenCode e nunca são armazenadas no OpenDeputy.",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponível como alternativa se a autenticação do OpenDeputy for removida",
  ...
  "settings.notifications.page.testNotification.body": "Esta é uma notificação de teste do OpenDeputy.",
