...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o OpenDeputy para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "OpenDeputy instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao OpenDeputy",
  ...
  "mobile.connect.password.placeholder": "Senha do OpenDeputy",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do OpenDeputy.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor OpenDeputy.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o OpenDeputy",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor OpenDeputy ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o OpenDeputy está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o OpenDeputy. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao OpenDeputy — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no OpenDeputy. Baixe-o para abrir em outro aplicativo.",
  ...
  'chat.voiceMode.start': 'Iniciar conversa por voz',
  'chat.voiceMode.title': 'Conversa por voz',
  'chat.voiceMode.description': 'Converse naturalmente com o OpenDeputy. Fechar esta tela mantém a conversa no chat.',
  'chat.voiceMode.preparing': 'Preparando...',
  'chat.voiceMode.thinking': 'Pensando...',
  'chat.voiceMode.speaking': 'Falando...',
  'chat.voiceMode.finishTurn': 'Terminar de falar',
  'chat.voiceMode.finishTurnHint': 'Fale naturalmente; uma breve pausa enviará sua mensagem.',
  'chat.voiceMode.muted': 'Microfone pausado',
  'chat.voiceMode.mute': 'Pausar microfone',
  'chat.voiceMode.unmute': 'Retomar microfone',
  'chat.voiceMode.close': 'Fechar conversa por voz',
  ...
  "directoryExplorerDialog.browse.permissionDenied": "OpenDeputy precisa acessar esta pasta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do OpenDeputy {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do OpenDeputy, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo OpenDeputy com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do OpenDeputy",
  "header.actions.openAppMenuAria": "Abrir menu do OpenDeputy",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o OpenDeputy de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do OpenDeputy",
  ...
  "multiRun.window.description": "Janela do OpenDeputy Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao OpenDeputy",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OpenDeputy não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do OpenDeputy. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do OpenDeputy e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do OpenDeputy para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor OpenDeputy ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do OpenDeputy. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando OpenDeputy, mas não é compatível com esta versão do app. Atualize o OpenDeputy no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando OpenDeputy. Verifique se o endereço aponta para um servidor OpenDeputy.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando OpenDeputy. Verifique se o endereço aponta para um servidor OpenDeputy.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor OpenDeputy em \"{host}\" não é compatível com esta versão do app. Atualize o OpenDeputy no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O OpenDeputy não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando OpenDeputy...",
  ...
  "mobileUpdate.toast.available.title": "Atualização do OpenDeputy disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o OpenDeputy aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do OpenDeputy",
