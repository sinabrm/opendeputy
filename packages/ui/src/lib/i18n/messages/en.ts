...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install OpenDeputy for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'OpenDeputy installed',
  ...
  'mobile.connect.welcome.title': 'Connect to OpenDeputy',
  ...
  'mobile.connect.password.placeholder': 'OpenDeputy password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an OpenDeputy connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that OpenDeputy server.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About OpenDeputy',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The OpenDeputy server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine OpenDeputy is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting OpenDeputy. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to OpenDeputy — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in OpenDeputy. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenDeputy needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OpenDeputy state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate OpenDeputy efficiently',
  ...
  'header.actions.openAppMenu': 'OpenDeputy menu',
  'header.actions.openAppMenuAria': 'Open OpenDeputy menu',
  ...
  'chat.voiceMode.start': 'Start voice conversation',
  'chat.voiceMode.title': 'Voice conversation',
  'chat.voiceMode.description': 'Talk naturally with OpenDeputy. Closing this view keeps the conversation in chat.',
  'chat.voiceMode.preparing': 'Getting ready...',
  'chat.voiceMode.thinking': 'Thinking...',
  'chat.voiceMode.speaking': 'Speaking...',
  'chat.voiceMode.finishTurn': 'Finish speaking',
  'chat.voiceMode.finishTurnHint': 'Speak naturally; a short pause sends your message.',
  'chat.voiceMode.muted': 'Microphone paused',
  'chat.voiceMode.mute': 'Pause microphone',
  'chat.voiceMode.unmute': 'Resume microphone',
  'chat.voiceMode.close': 'Close voice conversation',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening OpenDeputy from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock OpenDeputy',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote OpenDeputy servers',
  ...
  'multiRun.window.description': 'OpenDeputy Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to OpenDeputy',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OpenDeputy does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of OpenDeputy — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OpenDeputy settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an OpenDeputy server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an OpenDeputy server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different OpenDeputy version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running OpenDeputy but is not compatible with this app version. Update OpenDeputy on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running OpenDeputy. Verify the address points to an OpenDeputy server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running OpenDeputy. Verify the address points to an OpenDeputy server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The OpenDeputy server at "{host}" is not compatible with this app version. Update OpenDeputy on the server, then try again.',
  ...
  'startup.initRecovery.description': 'OpenDeputy could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating OpenDeputy...',
  ...
  'mobileUpdate.toast.available.title': 'OpenDeputy update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep OpenDeputy open.',
