...
export const thirdPartyIntegrationI18n = {
  en: {
    ...
    'settings.page.integrations.description': 'Add third-party subscriptions to use as OpenDeputy providers.',
    'settings.integrations.messengers.title': 'Messengers',
    'settings.integrations.messengers.info': 'Chat with OpenDeputy from Discord or Telegram. These bridges are not available yet.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Connect a Discord bot to chat with OpenDeputy.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Connect a Telegram bot to chat with OpenDeputy.',
    'settings.integrations.thirdParty.title': 'Third-party integrations',
    'settings.integrations.thirdParty.info': 'Install a provider plugin, then set up your subscription so OpenDeputy can use it.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor’s generous in-house model limits, now in OpenDeputy.',
  },
  de: {
    'settings.page.integrations.title': 'Integrationen',
    'settings.page.integrations.description': 'Füge Drittanbieter-Abonnements hinzu, um sie als OpenDeputy-Provider zu nutzen.',
    'settings.integrations.messengers.title': 'Messenger',
    'settings.integrations.messengers.info': 'Chatte mit OpenDeputy über Discord oder Telegram. Diese Bridges sind noch nicht verfügbar.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Verbinde einen Discord-Bot, um mit OpenDeputy zu chatten.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Verbinde einen Telegram-Bot, um mit OpenDeputy zu chatten.',
    'settings.integrations.thirdParty.title': 'Drittanbieter-Integrationen',
    'settings.integrations.thirdParty.info': 'Installiere ein Provider-Plugin und richte dein Abonnement ein, damit OpenDeputy es nutzen kann.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Die großzügigen Limits der Cursor-eigenen Modelle jetzt in OpenDeputy.',
  },
  fr: {
    'settings.page.integrations.title': 'Intégrations',
    'settings.page.integrations.description': 'Ajoutez des abonnements tiers à utiliser comme fournisseurs OpenDeputy.',
    'settings.integrations.messengers.title': 'Messagers',
    'settings.integrations.messengers.info': 'Discutez avec OpenDeputy depuis Discord ou Telegram. Ces ponts ne sont pas encore disponibles.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Connectez un bot Discord pour discuter avec OpenDeputy.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Connectez un bot Telegram pour discuter avec OpenDeputy.',
    'settings.integrations.thirdParty.title': 'Intégrations tierces',
    'settings.integrations.thirdParty.info': 'Installez un plugin de fournisseur, puis configurez votre abonnement pour qu’OpenDeputy puisse l’utiliser.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Les généreuses limites des modèles internes Cursor, désormais dans OpenDeputy.',
  },
  es: {
    'settings.page.integrations.title': 'Integraciones',
    'settings.page.integrations.description': 'Añade suscripciones de terceros para usarlas como proveedores de OpenDeputy.',
    'settings.integrations.messengers.title': 'Mensajeros',
    'settings.integrations.messengers.info': 'Chatea con OpenDeputy desde Discord o Telegram. Estos puentes aún no están disponibles.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Conecta un bot de Discord para chatear con OpenDeputy.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Conecta un bot de Telegram para chatear con OpenDeputy.',
    'settings.integrations.thirdParty.title': 'Integraciones de terceros',
    'settings.integrations.thirdParty.info': 'Instala un plugin de proveedor y configura tu suscripción para que OpenDeputy pueda usarla.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Los generosos límites de los modelos internos de Cursor, ahora en OpenDeputy.',
  },
  ja: {
    'settings.page.integrations.title': '連携',
    'settings.page.integrations.description': 'サードパーティのサブスクリプションを追加して、OpenDeputy のプロバイダーとして使います。',
    'settings.integrations.messengers.title': 'メッセンジャー',
    'settings.integrations.messengers.info': 'Discord または Telegram から OpenDeputy とチャットできます。これらの連携はまだ利用できません。',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Discord ボットを接続して OpenDeputy とチャットします。',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Telegram ボットを接続して OpenDeputy とチャットします。',
    'settings.integrations.thirdParty.title': 'サードパーティー連携',
    'settings.integrations.thirdParty.info': 'プロバイダープラグインをインストールし、サブスクリプションを設定して OpenDeputy で使えるようにします。',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 内蔵モデルの余裕ある制限が、OpenDeputy で使えます。',
  },
  ko: {
    'settings.page.integrations.title': '통합',
    'settings.page.integrations.description': '타사 구독을 추가해 OpenDeputy 프로바이더로 사용하세요.',
    'settings.integrations.messengers.title': '메신저',
    'settings.integrations.messengers.info': 'Discord 또는 Telegram에서 OpenDeputy와 채팅하세요. 이 브리지는 아직 사용할 수 없습니다.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Discord 봇을 연결해 OpenDeputy와 채팅하세요.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Telegram 봇을 연결해 OpenDeputy와 채팅하세요.',
    'settings.integrations.thirdParty.title': '서드파티 통합',
    'settings.integrations.thirdParty.info': '프로바이더 플러그인을 설치한 뒤 구독을 설정하면 OpenDeputy에서 사용할 수 있습니다.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 자체 모델의 넉넉한 한도를 이제 OpenDeputy에서.',
  },
  pl: {
    'settings.page.integrations.title': 'Integracje',
    'settings.page.integrations.description': 'Dodaj subskrypcje zewnętrzne, aby używać ich jako dostawców OpenDeputy.',
    'settings.integrations.messengers.title': 'Komunikatory',
    'settings.integrations.messengers.info': 'Czatuj z OpenDeputy przez Discord lub Telegram. Te mosty nie są jeszcze dostępne.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Połącz bota Discord, aby czatować z OpenDeputy.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Połącz bota Telegram, aby czatować z OpenDeputy.',
    'settings.integrations.thirdParty.title': 'Integracje zewnętrzne',
    'settings.integrations.thirdParty.info': 'Zainstaluj wtyczkę dostawcy, a następnie skonfiguruj subskrypcję, aby OpenDeputy mógł z niej korzystać.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Hojne limity wewnętrznych modeli Cursor teraz w OpenDeputy.',
  },
  'pt-BR': {
    'settings.page.integrations.title': 'Integrações',
    'settings.page.integrations.description': 'Adicione assinaturas de terceiros para usar como provedores do OpenDeputy.',
    'settings.integrations.messengers.title': 'Mensageiros',
    'settings.integrations.messengers.info': 'Converse com o OpenDeputy pelo Discord ou Telegram. Essas pontes ainda não estão disponíveis.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Conecte um bot do Discord para conversar com o OpenDeputy.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Conecte um bot do Telegram para conversar com o OpenDeputy.',
    'settings.integrations.thirdParty.title': 'Integrações de terceiros',
    'settings.integrations.thirdParty.info': 'Instale um plugin de provedor e configure sua assinatura para o OpenDeputy poder usá-la.',
    'settings.integrations.thirdParty.actions.install': 'Instalar',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Os limites generosos dos modelos internos do Cursor, agora no OpenDeputy.',
  },
  uk: {
    'settings.page.integrations.title': 'Інтеграції',
    'settings.page.integrations.description': 'Додайте сторонні підписки, щоб використовувати їх як провайдери OpenDeputy.',
    'settings.integrations.messengers.title': 'Месенджери',
    'settings.integrations.messengers.info': 'Спілкуйтеся з OpenDeputy у Discord або Telegram. Ці мости ще недоступні.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Підключіть бота Discord, щоб спілкуватися з OpenDeputy.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Підключіть бота Telegram, щоб спілкуватися з OpenDeputy.',
    'settings.integrations.thirdParty.title': 'Сторонні інтеграції',
    'settings.integrations.thirdParty.info': 'Установіть плагін провайдера, а потім налаштуйте підписку, щоб OpenDeputy міг її використовувати.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Щедрі ліміти внутрішніх моделей Cursor — тепер в OpenDeputy.',
  },
  'zh-CN': {
    'settings.page.integrations.title': '集成',
    'settings.page.integrations.description': '添加第三方订阅，将其用作 OpenDeputy 提供商。',
    'settings.integrations.messengers.title': '即时通讯',
    'settings.integrations.messengers.info': '通过 Discord 或 Telegram 与 OpenDeputy 聊天。这些桥接尚不可用。',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': '连接 Discord 机器人以与 OpenDeputy 聊天。',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': '连接 Telegram 机器人以与 OpenDeputy 聊天。',
    'settings.integrations.thirdParty.title': '第三方集成',
    'settings.integrations.thirdParty.info': '安装提供商插件并设置订阅，以便 OpenDeputy 可以使用它。',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 内部模型的充足额度，现已可用于 OpenDeputy。',
  },
  'zh-TW': {
    'settings.page.integrations.title': '整合',
    'settings.page.integrations.description': '新增第三方訂閱，將其用作 OpenDeputy 供應商。',
    'settings.integrations.messengers.title': '即時通訊',
    'settings.integrations.messengers.info': '透過 Discord 或 Telegram 與 OpenDeputy 聊天。這些橋接尚不可用。',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': '連接 Discord 機器人以與 OpenDeputy 聊天。',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': '連接 Telegram 機器人以與 OpenDeputy 聊天。',
    'settings.integrations.thirdParty.title': '第三方整合',
    'settings.integrations.thirdParty.info': '安裝供應商外掛並設定訂閱，以便 OpenDeputy 可以使用它。',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 內部模型的充足額度，現已可用於 OpenDeputy。',
  },
} as const;
