...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть OpenDeputy для швидшого доступу",
  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.dismiss": "Сховати",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "OpenDeputy встановлено",
  ...
  "mobile.connect.welcome.title": "Підключись до OpenDeputy",
  ...
  "mobile.connect.password.placeholder": "Пароль OpenDeputy",
  ...
  "mobile.connect.scan.invalid": "Це не QR-код підключення OpenDeputy.",
  ...
  "mobile.connect.relay.badge": "через OpenDeputy Relay",
  ...
  "mobile.connect.error.unreachable": "Не вдалося достукатись до цього OpenDeputy сервера.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Про OpenDeputy",
  ...
  "walkthrough.blocked.serverUnsupported.description": "Сервер OpenDeputy, до якого підключено застосунок, не відповів на walkthrough API — отже, він старіший за застосунок. Оновіть сервер до 1.18 або новішої версії та оновіть панель.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} працює на машині, де запущено OpenDeputy, і зʼєднання з ним відкрити не вдалося. Нічого зі своєї машини тут не показано.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Вони працюють на машині, де запущено OpenDeputy. Щоб їх відкрити, потрібен десктопний застосунок.",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до OpenDeputy — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",
  ...
  "filesView.editor.binaryFileDescription": "Цей файл є бінарним і його не можна редагувати в OpenDeputy. Завантажте його, щоб відкрити в іншій програмі.",
  ...
  'chat.voiceMode.start': 'Почати голосову розмову',
  'chat.voiceMode.title': 'Голосова розмова',
  'chat.voiceMode.description': 'Спілкуйтеся з OpenDeputy природно. Після закриття цього вікна розмова залишиться в чаті.',
  'chat.voiceMode.preparing': 'Підготовка...',
  'chat.voiceMode.thinking': 'Думаю...',
  'chat.voiceMode.speaking': 'Говорю...',
  'chat.voiceMode.finishTurn': 'Завершити мовлення',
  'chat.voiceMode.finishTurnHint': 'Говоріть природно; коротка пауза надішле повідомлення.',
  'chat.voiceMode.muted': 'Мікрофон призупинено',
  'chat.voiceMode.mute': 'Призупинити мікрофон',
  'chat.voiceMode.unmute': 'Відновити мікрофон',
  'chat.voiceMode.close': 'Закрити голосову розмову',
  ...
  "directoryExplorerDialog.browse.permissionDenied": "OpenDeputy потрібен доступ до цієї папки.",
  ...
  "aboutDialog.openChamberVersionLabel": "Версія OpenDeputy {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан OpenDeputy, стан OpenCode, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації OpenDeputy",
  ...
  "header.actions.openAppMenu": "Меню OpenDeputy",
  "header.actions.openAppMenuAria": "Відкрити меню OpenDeputy",
  ...
  "sessionAuth.error.networkDescription": "Нам не вдалося перевірити сесію інтерфейсу. Якщо ви відкриваєте OpenDeputy з іншого пристрою у локальній мережі, увімкніть Desktop Network Access у настільному застосунку та використайте LAN-адресу, показану в налаштуваннях.",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати OpenDeputy",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими OpenDeputy серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску OpenDeputy.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до OpenDeputy",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо OpenDeputy не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце OpenDeputy. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в OpenDeputy і перезавантажує конфігурацію OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера OpenDeputy для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер OpenDeputy або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Цей інстанс працює з іншою версією OpenDeputy. Можна підключитися, але оновіть обидва застосунки, якщо щось не працюватиме.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "Сервер працює з OpenDeputy, але несумісний із цією версією застосунку. Оновіть OpenDeputy на сервері та повторіть спробу.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює OpenDeputy. Перевірте, чи адреса вказує на сервер OpenDeputy.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено OpenDeputy. Перевірте, чи адреса вказує на сервер OpenDeputy.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Потрібне оновлення сервера",
  "onboarding.desktopRecovery.remoteIncompatible.description": "Сервер OpenDeputy на \"{host}\" несумісний із цією версією застосунку. Оновіть OpenDeputy на сервері та повторіть спробу.",
  ...
  "startup.initRecovery.description": "OpenDeputy не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення OpenDeputy...",
  ...
  "mobileUpdate.toast.available.title": "Доступне оновлення OpenDeputy",
  ...
  "opencodeUpdate.toast.upgrading.description": "Залиште OpenDeputy відкритим.",
  ...
  "openChamberLogo.aria.logo": "Логотип OpenDeputy",
