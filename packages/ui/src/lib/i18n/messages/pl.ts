...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj OpenDeputy, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'OpenDeputy został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z OpenDeputy',
  ...
  'mobile.connect.password.placeholder': 'Hasło OpenDeputy',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia OpenDeputy.',
  ...
  'mobile.connect.relay.badge': 'przez OpenDeputy Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem OpenDeputy.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O OpenDeputy',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia OpenDeputy.',
  ...
  'onboarding.chooser.title': 'Witaj w OpenDeputy',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli OpenDeputy nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień OpenDeputy i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera OpenDeputy aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer OpenDeputy, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji OpenDeputy. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia OpenDeputy, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj OpenDeputy na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim OpenDeputy. Zweryfikuj czy adres wskazuje na serwer OpenDeputy.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia OpenDeputy. Zweryfikuj czy adres wskazuje na serwer OpenDeputy.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer OpenDeputy pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj OpenDeputy na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'OpenDeputy nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan OpenDeputy, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja OpenDeputy {version}',
  ...
  'chat.voiceMode.start': 'Rozpocznij rozmowę głosową',
  'chat.voiceMode.title': 'Rozmowa głosowa',
  'chat.voiceMode.description': 'Rozmawiaj naturalnie z OpenDeputy. Zamknięcie tego widoku zachowa rozmowę na czacie.',
  'chat.voiceMode.preparing': 'Przygotowywanie...',
  'chat.voiceMode.thinking': 'Myślę...',
  'chat.voiceMode.speaking': 'Mówię...',
  'chat.voiceMode.finishTurn': 'Zakończ mówienie',
  'chat.voiceMode.finishTurnHint': 'Mów naturalnie; krótka pauza wyśle wiadomość.',
  'chat.voiceMode.muted': 'Mikrofon wstrzymany',
  'chat.voiceMode.mute': 'Wstrzymaj mikrofon',
  'chat.voiceMode.unmute': 'Wznów mikrofon',
  'chat.voiceMode.close': 'Zamknij rozmowę głosową',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer OpenDeputy, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest OpenDeputy, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest OpenDeputy. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do OpenDeputy — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami OpenDeputy',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenDeputy potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w OpenDeputy. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu OpenDeputy',
  'header.actions.openAppMenuAria': 'Otwórz menu OpenDeputy',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po OpenDeputy.',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz OpenDeputy z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj OpenDeputy',
  ...
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja OpenDeputy',
  ...
  'updateDialog.header.updating': 'Aktualizowanie OpenDeputy...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw OpenDeputy otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce OpenDeputy — zainstaluj je, aby zacząć.',
