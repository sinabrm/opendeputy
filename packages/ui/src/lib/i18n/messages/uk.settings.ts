...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Скопіюйте ID робочого простору з URL панелі, а cookie auth з інструментів розробника браузера. OpenDeputy ніколи не сканує сховище cookie браузера.',
  ...
  "settings.window.description": "Вікно налаштувань OpenDeputy.",
  ...
  "settings.page.appearance.description": "Налаштуйте вигляд і відчуття OpenDeputy.",
  ...
  "settings.remoteInstances.direct.title": "Інші сервери OpenDeputy",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Додайте інший сервер OpenDeputy за URL. Використовуйте це, коли сервер уже запущений і у вас є токен підключення.",
  ...
  "settings.remoteInstances.direct.import.description": "Вставте посилання для підключення з іншого сервера OpenDeputy.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Недійсне посилання підключення OpenDeputy.",
  ...
  "settings.remoteInstances.clientAuth.description": "Створіть безпечне посилання або токен, щоб OpenDeputy Desktop міг підключитися до цього сервера.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "QR-код підключення OpenDeputy",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Збільшити QR-код",
  "settings.remoteInstances.clientAuth.qrScanHint": "Скануй це застосунком OpenDeputy на іншому пристрої. Одноразовий і має термін дії.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Працює вдома і поза домом. Поза домом трафік іде через OpenDeputy Private Relay — наскрізно зашифрований тунель. Нічого налаштовувати не треба.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Відскануйте цей QR-код застосунком OpenDeputy на іншому пристрої.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Виберіть, чи OpenDeputy має запустити сервер для вас, чи підключитися до вже запущеного.",
  ...
  "settings.remoteInstances.page.field.keepServerRunningHint": "Залишати OpenDeputy запущеним на віддаленій машині після відключення.",
  ...
  "settings.openchamber.about.title": "Про OpenDeputy",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Додати репозиторій Git як нове джерело каталогу. OpenDeputy просканує його на наявність папок, що містять",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Запускати OpenDeputy під час входу в систему",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Запускати OpenDeputy під час входу в систему",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Показувати OpenDeputy у смузі меню macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Показувати OpenDeputy у смузі меню",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Потребує перезапуску застосунку. Якщо вимкнено, OpenDeputy не створює елемент смуги меню та не запускає пов’язані оновлення сесій, запитів на підтвердження й використання.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Закривати OpenDeputy у системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Закривати в системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Залишає OpenDeputy запущеним у системному треї, коли головне вікно закрито. Під час згортання вікно залишається на панелі завдань.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Не давати комп’ютеру засинати, поки OpenDeputy запущено",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Не давати комп’ютеру засинати, поки OpenDeputy запущено",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "OpenDeputy попросить пароль після перезапуску, а потім коли сесія логіну спливе: через 12 годин або через 7 днів із «Довіряти цьому пристрою». Залиште порожнім, щоб вимкнути логін.",
  ...
  "settings.openchamber.tools.title": "Інструменти OpenDeputy",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Інструмент OpenDeputy Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Увімкнути інструмент OpenDeputy Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Дозвольте агентам переглядати сторінку в панелі браузера OpenDeputy і взаємодіяти з нею: відкривати URL, читати вміст, клікати, вводити текст, гортати та перемикатися між мобільним і десктопним виглядом. Додає невеликий опис інструмента до кожної сесії. Застосовується після перезапуску OpenCode.",
  ...
  "settings.openchamber.opencodeCli.field.autoUpdate": "Оновлювати OpenCode автоматично",
  "settings.openchamber.opencodeCli.field.autoUpdateAria": "Оновлювати OpenCode автоматично",
  "settings.openchamber.opencodeCli.field.autoUpdateDescription": "Установлювати майбутні оновлення OpenCode без повідомлення про доступність.",
  ...
  "settings.remoteInstances.page.description": "Підключіться до іншої машини через SSH і відкрийте там OpenDeputy.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "OpenDeputy на віддаленій машині",
  "settings.remoteInstances.page.section.remoteServerDescription": "Виберіть, як OpenDeputy має працювати після SSH-підключення.",
  "settings.remoteInstances.page.section.mainTunnel": "Локальний доступ",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Виберіть локальну адресу, через яку відкриватиметься цей віддалений сервер OpenDeputy.",
  "settings.remoteInstances.page.section.authentication": "Аутентифікація",
  "settings.remoteInstances.page.section.authenticationDescription": "Додаткові облікові дані для SSH та віддаленого інтерфейсу користувача OpenDeputy.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Як розмістити OpenDeputy на віддаленій машині, коли цей застосунок запускає його для вас.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Встановлення OpenDeputy",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Оновлення OpenDeputy",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Зберігається в автентифікації OpenCode, не OpenDeputy. Використовуйте {env:VAR_NAME}, щоб читати ключ зі змінної середовища.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Ключі надсилаються безпосередньо до OpenCode і ніколи не зберігаються в OpenDeputy.",
  ...
  "settings.github.page.flow.title": "Авторизувати OpenDeputy",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Доступно як резервний варіант, якщо автентифікацію OpenDeputy видалено",
  ...
  "settings.notifications.page.testNotification.body": "Це тестове сповіщення від OpenDeputy.",
  ...
  "settings.voice.page.tooltip.localTts": "Безкоштовний синтез на пристрої (Kokoro для англійської, Piper для перської та голоси пристрою для інших мов). Моделі завантажуються автоматично; без ключа API.",
