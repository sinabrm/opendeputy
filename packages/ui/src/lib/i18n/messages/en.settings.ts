...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. OpenDeputy never scans browser cookie storage.',
  ...
  'settings.window.description': 'OpenDeputy settings window.',
  ...
  'settings.page.appearance.description': 'Customize how OpenDeputy looks and feels.',
  ...
  'settings.remoteInstances.direct.title': 'Other OpenDeputy servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another OpenDeputy server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another OpenDeputy server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid OpenDeputy connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so OpenDeputy Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the OpenDeputy app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through OpenDeputy Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the OpenDeputy app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether OpenDeputy should start the server for you, or connect to one that is already running.',
  ...
  'settings.openchamber.about.title': 'About OpenDeputy',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. OpenDeputy will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start OpenDeputy at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start OpenDeputy when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show OpenDeputy in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show OpenDeputy in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, OpenDeputy does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Close OpenDeputy to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps OpenDeputy running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while OpenDeputy is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while OpenDeputy is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpenDeputy asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.tools.title': 'OpenDeputy Tools',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'OpenDeputy Web tool',
  'settings.openchamber.tools.field.agentWebToolAria': 'Enable the OpenDeputy Web tool',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in OpenDeputy\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  ...
  'settings.openchamber.opencodeCli.field.autoUpdate': 'Update OpenCode automatically',
  'settings.openchamber.opencodeCli.field.autoUpdateAria': 'Update OpenCode automatically',
  'settings.openchamber.opencodeCli.field.autoUpdateDescription': 'Install future OpenCode updates without showing the availability prompt.',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open OpenDeputy there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'OpenDeputy on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how OpenDeputy should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote OpenDeputy server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote OpenDeputy UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How OpenDeputy should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing OpenDeputy',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating OpenDeputy',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by OpenDeputy. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by OpenDeputy.',
  ...
  'settings.github.page.flow.title': 'Authorize OpenDeputy',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if OpenDeputy auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from OpenDeputy.',
  ...
  'settings.voice.page.tooltip.localTts': 'Free on-device synthesis (Kokoro for English, Piper for Persian, and device voices for other languages). Models download automatically; no API key needed.',
