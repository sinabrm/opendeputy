  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running OpenDeputy. Verify the address points to an OpenDeputy server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The OpenDeputy server at "${host || 'unknown'}" is not compatible with this app version. Update OpenDeputy on the server, then try again.`,
