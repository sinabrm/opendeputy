const DEFAULT_PWA_APP_NAME = 'OpenDeputy - AI Coworker';
...
export const registerPwaManifestRoute = (app, dependencies) => {
  ...
  app.get('/manifest.webmanifest', async (req, res) => {
    ...
    const manifest = {
      ...
      description: 'A Windows-first, open-source AI coworker for projects, files, terminals, websites, and desktop applications.',
      id: '/',
      start_url: '/',
      scope: '/',
      display: 'standalone',
