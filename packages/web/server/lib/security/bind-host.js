...
export const getUnauthenticatedLanErrorMessage = (host) =>
  `OpenDeputy refuses to bind to ${host || 'a network-exposed host'} without UI authentication. `
  + 'Set --ui-password or OPENDEPUTY_UI_PASSWORD before exposing it over LAN, '
