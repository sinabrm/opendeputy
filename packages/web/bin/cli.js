...
const isCliExecution = isModuleCliExecution(process.argv[1], import.meta.url, fs.realpathSync, 'opencode') || isModuleCliExecution(process.argv[1], import.meta.url, fs.realpathSync, 'openchamber');
