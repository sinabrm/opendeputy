...
5. If structured inspection still fails, call `visual_grounding_locate_target`. It rejects blank frames and uses local OCR plus OmniParser first; MiMo labels numbered regions only when local matching is insufficient.
